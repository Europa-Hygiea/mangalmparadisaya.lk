...
function toggle_side() {
  $(".side-name").toggleClass("side-name-active");
  $("#dash_side").toggleClass("dash-side");
  $("#dash_side").toggleClass("dash-side-active");
  $("#dash-main").toggleClass("dash-main");
  $("#dash-main").toggleClass("dash-main-active");
  $("#set-icn").toggleClass("fa-chevron-right");
}
